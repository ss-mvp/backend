 ...
 */
const runScript = (
    scriptPath, // Matches a key of the `Scripts` interface which is a path to the script being used
    inputData, // Uses the `input` type for the selected Script
    findResults // Uses the output data type of the selected Script
) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        let out = []; // An array of all the terminal outputs
